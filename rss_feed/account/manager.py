...
class MyUserManager(BaseUserManager):
    ...
    def _create_user(self,phone, username, email, password, **extra_fields):
        """
    ...
    def create_user(self, phone, username=None, email=None, password=None, **extra_fields):
        ...
        return self._create_user(phone=phone, username=username, email=email, password=password, **extra_fields)
    ...
    def with_perm(
        self, perm, is_active=None, include_superusers=True, backend=None, obj=None
    ):
        if backend is None:
